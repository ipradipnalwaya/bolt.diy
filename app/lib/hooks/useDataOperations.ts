...
export function useDataOperations({
  ...
  const handleExportSettings = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = 'webbanao-settings.json';
  ...
  const handleExportSelectedSettings = useCallback(
    async (categoryIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `webbanao-settings-${categoryIds.join('-')}.json`;
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleExportAllChats = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'webbanao-chats.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportSelectedChats = useCallback(
    async (chatIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'webbanao-selected-chats.json';
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleDownloadTemplate = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'webbanao-api-keys-template.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportAPIKeys = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'webbanao-api-keys.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
