...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('webbanao_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('webbanao_profile', JSON.stringify(profileStore.get()));
  }
};
