...
export class WorkbenchStore {
  ...
  get webbanaoTerminal() {
    return this.#terminalStore.webbanaoTerminal;
  }
  get alert() {
  ...
  attachWebBanaoTerminal(terminal: ITerminal) {
    this.#terminalStore.attachWebBanaoTerminal(terminal);
  }
