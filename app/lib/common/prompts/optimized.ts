...
<artifact_info>
  ...
  - Use \`<webbanaoArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<webbanaoAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<webbanaoArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<webbanaoAction>\` tags with appropriate \`type\` attribute:
