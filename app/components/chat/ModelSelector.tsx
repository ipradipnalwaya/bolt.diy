...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-lg border border-webbanao-elements-borderColor bg-webbanao-elements-prompt-background text-webbanao-elements-textPrimary">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2 rounded-lg border border-webbanao-elements-borderColor',
            'bg-webbanao-elements-prompt-background text-webbanao-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-webbanao-elements-focus',
            'transition-all cursor-pointer',
            isProviderDropdownOpen ? 'ring-2 ring-webbanao-elements-focus' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-webbanao-elements-textSecondary opacity-75',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-webbanao-elements-borderColor bg-webbanao-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-webbanao-elements-background-depth-2 border border-webbanao-elements-borderColor',
                    'text-webbanao-elements-textPrimary placeholder:text-webbanao-elements-textTertiary',
                    'focus:outline-none focus:ring-2 focus:ring-webbanao-elements-focus',
                    'transition-all',
                  )}
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-webbanao-elements-textTertiary" />
                </div>
                {providerSearchQuery && (
                  <button
                    type="button"
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 rounded hover:bg-webbanao-elements-background-depth-3 transition-colors"
                    aria-label="Clear search"
                  >
                    <span className="i-ph:x text-webbanao-elements-textTertiary text-xs" />
                  </button>
                )}
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:bg-webbanao-elements-borderColor',
                '[&::-webkit-scrollbar-thumb]:hover:bg-webbanao-elements-borderColorHover',
                '[&::-webkit-scrollbar-thumb]:rounded-full',
                '[&::-webkit-scrollbar-track]:bg-webbanao-elements-background-depth-2',
                '[&::-webkit-scrollbar-track]:rounded-full',
                'sm:[&::-webkit-scrollbar]:w-1.5 sm:[&::-webkit-scrollbar]:h-1.5',
                'sm:hover:[&::-webkit-scrollbar-thumb]:bg-webbanao-elements-borderColor/50',
                'sm:hover:[&::-webkit-scrollbar-thumb:hover]:bg-webbanao-elements-borderColor',
                'sm:[&::-webkit-scrollbar-track]:bg-transparent',
              )}
            >
              {filteredProviders.length === 0 ? (
                <div className="px-3 py-3 text-sm">
                  <div className="text-webbanao-elements-textTertiary mb-1">
                    {debouncedProviderSearchQuery
                      ? `No providers match "${debouncedProviderSearchQuery}"`
                      : 'No providers found'}
                  </div>
                  {debouncedProviderSearchQuery && (
                    <div className="text-xs text-webbanao-elements-textTertiary">
                ...
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      ...
                      'hover:bg-webbanao-elements-background-depth-3',
                      'text-webbanao-elements-textPrimary',
                      'outline-none',
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ? 'bg-webbanao-elements-background-depth-2'
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-webbanao-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-webbanao-elements-focus',
            'transition-all cursor-pointer',
            isModelDropdownOpen ? 'ring-2 ring-webbanao-elements-focus' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-lg border border-webbanao-elements-borderColor bg-webbanao-elements-background-depth-2 shadow-lg"
            role="listbox"
            id="model-listbox"
          >
            <div className="px-2 pb-2 space-y-2">
              ...
              {provider?.name === 'OpenRouter' && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={classNames(
                      ...
                      showFreeModelsOnly
                        ...
                        : 'bg-webbanao-elements-background-depth-3 text-webbanao-elements-textSecondary border border-webbanao-elements-borderColor',
                    )}
                  >
                  ...
                  {showFreeModelsOnly && (
                    <span className="text-xs text-webbanao-elements-textTertiary">
              ...
              {debouncedModelSearchQuery && filteredModels.length > 0 && (
                <div className="text-xs text-webbanao-elements-textTertiary px-1">
            ...
            >
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-3 text-sm">
                  <div className="flex items-center gap-2 text-webbanao-elements-textTertiary">
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-webbanao-elements-background-depth-2'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-webbanao-elements-focus' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
