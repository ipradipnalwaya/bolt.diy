      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-webbanao-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-webbanao-elements-item-backgroundAccent hover:bg-webbanao-elements-artifacts-backgroundHover"
