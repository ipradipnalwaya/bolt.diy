              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={classNames('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-webbanao-elements-textTertiary hover:text-webbanao-elements-textPrimary': !isActive,
                    'text-webbanao-elements-textPrimary underline': isActive,
                    'pr-4': isLast,
                  })}
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-webbanao-elements-background-depth-1 border border-webbanao-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
                        ...
                        <DropdownMenu.Arrow className="fill-webbanao-elements-borderColor" />
                      </motion.div>
                    </DropdownMenu.Content>
                  </DropdownMenu.Portal>
                )}
