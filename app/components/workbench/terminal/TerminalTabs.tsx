  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-webbanao-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-webbanao-elements-background-depth-2 border-y border-webbanao-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-webbanao-elements-terminals-buttonBackground text-webbanao-elements-textSecondary hover:text-webbanao-elements-textPrimary':
                            isActive,
                          'bg-webbanao-elements-background-depth-2 text-webbanao-elements-textSecondary hover:bg-webbanao-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-webbanao-elements-terminals-buttonBackground text-webbanao-elements-textPrimary': isActive,
                            'bg-webbanao-elements-background-depth-2 text-webbanao-elements-textSecondary hover:bg-webbanao-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-webbanao-elements-textTertiary hover:text-webbanao-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachWebBanaoTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting webbanao terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachWebBanaoTerminal(terminal)}
