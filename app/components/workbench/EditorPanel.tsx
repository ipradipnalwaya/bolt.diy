      ...
      <PanelGroup direction="vertical">
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={20}>
          <PanelGroup direction="horizontal">
            <Panel defaultSize={20} minSize={15} collapsible className="border-r border-webbanao-elements-borderColor">
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-webbanao-elements-textSecondary px-1">
                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-webbanao-elements-background-depth-3 py-0.5 px-2 rounded-lg text-sm font-medium text-webbanao-elements-textTertiary hover:text-webbanao-elements-textPrimary data-[state=active]:text-webbanao-elements-textPrimary',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
