      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-webbanao-elements-textPrimary">Local AI Providers</h2>
              <p className="text-sm text-webbanao-elements-textSecondary">Configure and manage your local AI models</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-webbanao-elements-textSecondary">Enable All</span>
              <Switch
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-webbanao-elements-background-depth-2 hover:bg-webbanao-elements-background-depth-3 border-webbanao-elements-borderColor hover:border-purple-500/30 transition-all duration-200 gap-2"
              >
          ...
          {filteredProviders.map((provider) => (
            <div key={provider.name} className="space-y-4">
              ...
              {provider.name === 'Ollama' && provider.settings.enabled && (
                <Card className="mt-4 bg-webbanao-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <PackageOpen className="w-5 h-5 text-purple-500" />
                        <h3 className="text-lg font-semibold text-webbanao-elements-textPrimary">Installed Models</h3>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                        ...
                        className="bg-transparent hover:bg-webbanao-elements-background-depth-2"
                      >
                        {isLoadingModels ? (
                  ...
                  <CardContent className="space-y-4">
                    {isLoadingModels ? (
                      ...
                      <div className="text-center py-8">
                        <PackageOpen className="w-16 h-16 mx-auto text-webbanao-elements-textTertiary mb-4" />
                        <h3 className="text-lg font-medium text-webbanao-elements-textPrimary mb-2">No Models Installed</h3>
                        <p className="text-sm text-webbanao-elements-textSecondary mb-4">
                          Visit{' '}
                          <a
                ...
                <Card className="mt-4 bg-webbanao-elements-background-depth-2">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-semibold text-webbanao-elements-textPrimary">Available Models</h3>
                      </div>
                      <Button
                        variant="outline"
                        size="sm"
                  ...
                  <CardContent className="space-y-4">
                    {isLoadingLMStudioModels ? (
                      ...
                      <div className="text-center py-8">
                        <Monitor className="w-16 h-16 mx-auto text-webbanao-elements-textTertiary mb-4" />
                        <h3 className="text-lg font-medium text-webbanao-elements-textPrimary mb-2">No Models Available</h3>
                        <p className="text-sm text-webbanao-elements-textSecondary mb-4">
                      ...
                      <div className="grid gap-4">
                        {lmStudioModels.map((model) => (
                          <Card key={model.id} className="bg-webbanao-elements-background-depth-3">
                            <CardContent className="p-4">
                              <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                  <h4 className="text-sm font-medium text-webbanao-elements-textPrimary font-mono">
                                    {model.id}
                                  </h4>
        ...
        {filteredProviders.length === 0 && (
          <Card className="bg-webbanao-elements-background-depth-2">
            <CardContent className="p-8 text-center">
              <Server className="w-16 h-16 mx-auto text-webbanao-elements-textTertiary mb-4" />
              <h3 className="text-lg font-medium text-webbanao-elements-textPrimary mb-2">No Local Providers Available</h3>
