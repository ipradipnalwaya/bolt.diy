...
function ModelCard({ model, onUpdate, onDelete }: ModelCardProps) {
  return (
    <Card className="bg-webbanao-elements-background-depth-3 hover:bg-webbanao-elements-background-depth-4 transition-all duration-200 shadow-sm hover:shadow-md border border-webbanao-elements-borderColor hover:border-purple-500/20">
      <CardContent className="p-5">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-medium text-webbanao-elements-textPrimary font-mono">{model.name}</h4>
        ...
        {model.progress && (
          <div className="mt-3 space-y-2">
            <div className="flex justify-between text-xs text-webbanao-elements-textSecondary">
