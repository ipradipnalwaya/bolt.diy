      ...
      >
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-webbanao-elements-textPrimary">Cloud Providers</h4>
              <p className="text-sm text-webbanao-elements-textSecondary">Connect to cloud-based AI models and services</p>
            </div>
          </div>

          <div className="flex items-center gap-2">
            <span className="text-sm text-webbanao-elements-textSecondary">Enable All Cloud</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filteredProviders.map((provider, index) => (
            <motion.div
              key={provider.name}
              className={classNames(
                'rounded-lg border bg-webbanao-elements-background text-webbanao-elements-textPrimary shadow-sm',
              ...
              <div className="flex items-start gap-4 p-4">
                <motion.div
                  className={classNames(
                    ...
                    'bg-webbanao-elements-background-depth-3 group-hover:bg-webbanao-elements-background-depth-4',
                    'transition-all duration-200',
                    provider.settings.enabled ? 'text-purple-500' : 'text-webbanao-elements-textSecondary',
                  )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-4 mb-2">
                    <div>
                      <h4 className="text-sm font-medium text-webbanao-elements-textPrimary group-hover:text-purple-500 transition-colors">
                        {provider.name}
                      </h4>
                      <p className="text-xs text-webbanao-elements-textSecondary mt-0.5">
                        ...
                        {editingProvider === provider.name ? (
                          <input
                            ...
                            className={classNames(
                              ...
                              'bg-webbanao-elements-background-depth-3 border border-webbanao-elements-borderColor',
                          ...
                          >
                            <div className="flex items-center gap-2 text-webbanao-elements-textSecondary">
