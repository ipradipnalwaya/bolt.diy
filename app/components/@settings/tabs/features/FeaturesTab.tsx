      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={classNames(feature.icon, 'w-5 h-5 text-webbanao-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-webbanao-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-webbanao-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-webbanao-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
  ...
  ({
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-lg font-medium text-webbanao-elements-textPrimary">{title}</h3>
          <p className="text-sm text-webbanao-elements-textSecondary">{description}</p>
        </div>
      </div>
