    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from WebBanao.diy' : 'Update from WebBanao.diy',
          tree: treeData.sha,
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-webbanao-elements-background-depth-1 rounded-lg border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-webbanao-elements-textTertiary hover:text-webbanao-elements-textPrimary dark:text-webbanao-elements-textTertiary-dark dark:hover:text-webbanao-elements-textPrimary-dark hover:bg-webbanao-elements-background-depth-2 dark:hover:bg-webbanao-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-webbanao-elements-borderColor dark:focus:ring-webbanao-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 rounded-lg p-4 text-left border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark">
                    <p className="text-sm font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:github-logo w-4 h-4 text-purple-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-webbanao-elements-background-depth-1 dark:bg-webbanao-elements-background-depth-4 px-3 py-2 rounded border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-webbanao-elements-textSecondary hover:text-webbanao-elements-textPrimary dark:text-webbanao-elements-textSecondary-dark dark:hover:text-webbanao-elements-textPrimary-dark bg-webbanao-elements-background-depth-1 dark:bg-webbanao-elements-background-depth-4 rounded-lg border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark"
                  ...
                  <div className="bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 rounded-lg p-4 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark">
                    <p className="text-sm font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark mb-2 flex items-center gap-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark border-b border-webbanao-elements-borderColor/30 dark:border-webbanao-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-webbanao-elements-background-depth-3 dark:bg-webbanao-elements-background-depth-4 text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark ml-2">
                            {(file.size / 1024).toFixed(1)} KB
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark hover:bg-webbanao-elements-background-depth-3 dark:hover:bg-webbanao-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark hover:bg-webbanao-elements-background-depth-3 dark:hover:bg-webbanao-elements-background-depth-4 text-sm border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-webbanao-elements-background-depth-1 rounded-lg p-6 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark shadow-xl"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-webbanao-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitHub, you need to connect your GitHub account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark text-sm hover:bg-webbanao-elements-background-depth-3 dark:hover:bg-webbanao-elements-background-depth-4 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-webbanao-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                    <div className="i-ph:github-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark">
                      Deploy to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 rounded-lg border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark">
                  ...
                  <div>
                    <p className="text-sm font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark">
                      {user.name || user.login}
                    </p>
                    <p className="text-sm text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark">
                      @{user.login}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-webbanao-elements-textTertiary dark:text-webbanao-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark placeholder-webbanao-elements-textTertiary dark:placeholder-webbanao-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-purple-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-webbanao-elements-textTertiary dark:text-webbanao-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 hover:bg-webbanao-elements-background-depth-3 dark:hover:bg-webbanao-elements-background-depth-4 transition-colors group border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark hover:border-purple-500/30"
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark group-hover:text-purple-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-webbanao-elements-textSecondary dark:text-webbanao-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 rounded-lg border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark text-purple-500 focus:ring-purple-500 dark:bg-webbanao-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-webbanao-elements-textTertiary dark:text-webbanao-elements-textTertiary-dark mt-2 ml-6">
