        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-webbanao-elements-background-depth-2 dark:bg-webbanao-elements-background-depth-3 text-webbanao-elements-textPrimary dark:text-webbanao-elements-textPrimary-dark hover:bg-webbanao-elements-background-depth-3 dark:hover:bg-webbanao-elements-background-depth-4 border border-webbanao-elements-borderColor dark:border-webbanao-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
