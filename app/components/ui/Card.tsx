  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-webbanao-elements-borderColor bg-webbanao-elements-background-depth-1 text-webbanao-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-webbanao-elements-textSecondary', className)} {...props} />;
  },
);
